...

{
  ...
  #networking.wireless.networks = { You can define your wireless network here if you don't want to use ethernet cable.;
  ...
  environment.systemPackages = [
      ...
      pkgs.nssmdns  
      pkgs.cron
      (import ./holesail.nix { inherit pkgs; }) # This is to install Holesail!!
  ];  
  ...
  #### This services initializes the system and checks stuff after each reboot. ####
  ...
  systemd.services.p2pmagic = {
    description = "MAGIC";
    enable = true;
    path = [ (import ./holesail.nix { inherit pkgs; }) pkgs.util-linux ];
    script = ''
  ...
  system.stateVersion = "24.05"; ### Just don't change this.
